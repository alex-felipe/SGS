                        ...
                        <table class="table">
                          ...
                          %>
                                <tr class="odd">
                                    ...
                                    <td>
                                        <% if((fase.isIniciada() && (! fase.isFinalizada())) && (! participante.isAvaliado())){%>
                                        <a href="avaliar_participante.jsp?id_participante=<%=participante.getId()%>" class="link_button" type="button">
                                          <img src="../theme/images/icons/application_edit.png" alt="Avaliar" /> Avaliar
                                        </a>
                                        <% }else if(! fase.isFinalizada()){
                                        
                                        %>
                                        <a href="editar_avaliacao.jsp?id_participante=<%=participante.getId()%>" class="link_button" type="button">
                                          <img src="../theme/images/icons/tick.png" alt="Avaliado" /> Editar Avaliação
                                        </a>                                        
                                        <%
                                            }
                                        %>
