<%@page import="br.ufc.sgs.dao.AvaliadorDAO"%>
...
<body>
    ...
    <%
        ...
        Fase fase = null;
        ArrayList<Avaliador> avaliadores = null;
        for(Concurso c: listaConcursos){
            for(Fase f: c.getFases()){
                if(f.getId() == id_fase){
                    fase = f;
                    avaliadores = new ArrayList(fase.getAvaliadores());
                    break;
                }
            }
                      ...
                      <form action="#" class="form">
                        ...
                        <div class="actions-bar wat-cf">
                          <div class="actions">
                            ...
                            <a href="cadastrar_concurso.jsp" class="button" >
                                <img src="../theme/images/icons/add.png" alt="Adicionar avaliadores" /> Adicionar avaliadores
                            </a>
                          </div>
                        </div>
                      </form>
