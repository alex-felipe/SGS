        ...
        <div id="main">
            <div class="block" id="block-tables">
              <div class="secondary-navigation">
                <ul class="wat-cf">
                  <li class="active"><a href="#block-text">Inscrições</a></li>
                  <li class="last"><a href="#block-tables">Resultados</a></li>
                </ul>
              </div>
              <div class="content">
                <div class="inner">
                  <form action="#" class="form">
                    ...
                    <table class="table">
                      ...
                      <tbody>
                      <%
                          ArrayList<Concurso> concursos = (ArrayList<Concurso>) request.getSession().getAttribute("concursos");
                          for(Concurso concurso: concursos){
                              if((! listaConcursos.contains(concurso)) && (concurso.isIsDivulgado()) && (concurso.isInscricoesAbertas())){
                      %>
                            <tr class="odd">
                                ...
                                <td><%
                                    if(concurso.getFaseAtual() != null) out.println(concurso.getFaseAtual().getTitulo()); else out.println("Nenhuma"); %> </td>
                                <td><%= concurso.getDataTermino() %></td>
                                <td class="last">
                                    <center>
                                        <a href="concurso.jsp?id=<%= concurso.getId() %>">visualizar</a> | 
                                        <a href="inscricao.jsp?id_concurso=<%= concurso.getId() %>">inscrever-se</a>
                                    </center>
                                </td>
                            </tr>
                      <%
                    ...
                    <table class="table">
                      ...
                      %>
                            <tr class="odd">
                                ...
                                <td class="last">
                                    <center>
                                        <a href="concurso.jsp?id=<%= concurso.getId() %>">acompanhar inscrição</a>
                                    </center>
                                </td>
                            </tr>
                      <%
